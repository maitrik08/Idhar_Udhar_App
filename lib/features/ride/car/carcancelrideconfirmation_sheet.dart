...
import 'carcancelationfail_sheet.dart'; // Make sure this has AppColors.red etc.

void showCarCancelConfirmationSheet(BuildContext context) {
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                showCarCancellationFailedSheet(context);
              },
