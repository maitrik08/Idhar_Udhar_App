...
class NoAutoDriverScreen extends StatefulWidget {
  const NoAutoDriverScreen({super.key});

  @override
  State<NoAutoDriverScreen> createState() => _NoAutoDriverScreenState();
}

class _NoAutoDriverScreenState extends State<NoAutoDriverScreen> {
  int? selectedAmount;
