...
class ConfirmAutoPickupScreen extends StatefulWidget {
  static const LatLng _center = LatLng(23.0225, 72.5714);

  const ConfirmAutoPickupScreen({super.key});

  @override
  State<ConfirmAutoPickupScreen> createState() => _ConfirmAutoPickupScreenState();
}

class _ConfirmAutoPickupScreenState extends State<ConfirmAutoPickupScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          const GoogleMap(
            initialCameraPosition: CameraPosition(
              target: ConfirmAutoPickupScreen._center,
              zoom: 12.0,
            ),
            myLocationEnabled: true,
            myLocationButtonEnabled: false,
