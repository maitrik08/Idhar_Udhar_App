...
class SearchingAutoDriverScreen extends StatefulWidget {
  const SearchingAutoDriverScreen({super.key});

  @override
  State<SearchingAutoDriverScreen> createState() => _SearchingAutoDriverScreenState();
}

class _SearchingAutoDriverScreenState extends State<SearchingAutoDriverScreen> {
  ...
  void _onTimerComplete() {
    ...
    Navigator.pushNamed(context, '/noautodriver'); // Or navigate to another screen
  }
    ...
    return Scaffold(
        ...
        floatingActionButton:Container(
          ...
          child:TextButton(
            onPressed: () {
              _timer?.cancel();
              Navigator.pushNamed(context, '/confirmautorpickup');
            },
            child: Text('pickup'),
          ),
        )
