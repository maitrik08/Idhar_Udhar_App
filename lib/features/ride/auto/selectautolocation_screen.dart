...
class SelectAutoLocationScreen extends StatefulWidget {
  const SelectAutoLocationScreen({super.key});

  @override
  State<SelectAutoLocationScreen> createState() => _SelectAutoLocationScreenState();
}

class _SelectAutoLocationScreenState extends State<SelectAutoLocationScreen> {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(context, '/bookauto');
