...
import 'autocancelationfail_sheet.dart'; // Make sure this has AppColors.red etc.

void showCancelautoConfirmationSheet(BuildContext context) {
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                showautoCancellationFailedSheet(context);
              },
