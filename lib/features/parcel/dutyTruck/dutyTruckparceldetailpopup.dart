...
import 'dutyTruckparceldriverdetail.dart';

class DutyTruckParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const DutyTruckParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const DutyTruckParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
