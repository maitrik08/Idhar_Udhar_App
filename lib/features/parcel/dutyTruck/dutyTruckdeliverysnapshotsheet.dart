...
class DutyTruckDeliverySnapshotContent extends StatelessWidget {
  const DutyTruckDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/8.png',color: Colors.white,width: 35, height: 35),
              const SizedBox(width: 10),
              Expanded(
                child: Text("Medium Duty Truck",
