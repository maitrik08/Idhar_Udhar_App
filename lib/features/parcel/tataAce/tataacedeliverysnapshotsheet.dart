...
class TataAceDeliverySnapshotContent extends StatelessWidget {
  const TataAceDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/1.png',color: Colors.white,width: 35, height: 35),
