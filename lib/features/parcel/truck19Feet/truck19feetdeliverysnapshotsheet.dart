...
class Truck19feetDeliverySnapshotContent extends StatelessWidget {
  const Truck19feetDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/7.png',color: Colors.white,width: 35, height: 35),
              const SizedBox(width: 10),
              Expanded(
                child: Text("19 Feet Truck",
