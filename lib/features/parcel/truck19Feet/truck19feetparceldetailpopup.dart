...
import 'truck19feetparceldriverdetail.dart';

class Truck19feetParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const Truck19feetParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const Truck19feetParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
