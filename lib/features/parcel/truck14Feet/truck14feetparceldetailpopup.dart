...
import 'truck14feetparceldriverdetail.dart';

class Truck14feetParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const Truck14feetParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const Truck14feetParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
