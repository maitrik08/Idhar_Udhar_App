...
class Truck14feetDeliverySnapshotContent extends StatelessWidget {
  const Truck14feetDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/6.png',color: Colors.white,width: 35, height: 35),
              const SizedBox(width: 10),
              Expanded(
                child: Text("14 Feet Truck",
