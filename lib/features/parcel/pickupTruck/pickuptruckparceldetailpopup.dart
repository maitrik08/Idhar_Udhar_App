...
import 'pickuptruckparceldriverdetail.dart';

class PickupTruckParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const PickupTruckParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const PickupTruckParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
