...
class PickupTruckDeliverySnapshotContent extends StatelessWidget {
  const PickupTruckDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/2.png',color: Colors.white,width: 35, height: 35),
