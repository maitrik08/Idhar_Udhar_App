...
import 'carparceldriverdetail.dart';


class CarParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const CarParcelDetailsPopup({super.key, this.pin = "1234"});
                      ...
                      InkWell(
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            builder: (context) => const CarParcelDriverDetailsPopup(),
                          );
                        },
                        child: Container(
                          decoration: BoxDecoration(
