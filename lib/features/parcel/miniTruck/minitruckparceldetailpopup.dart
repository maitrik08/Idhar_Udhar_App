...
import 'minitruckparceldriverdetail.dart';

class MiniTruckParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const MiniTruckParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const MiniTruckParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
