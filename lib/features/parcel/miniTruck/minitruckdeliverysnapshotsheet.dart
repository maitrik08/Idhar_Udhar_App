...
class MiniTruckDeliverySnapshotContent extends StatelessWidget {
  const MiniTruckDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/3.png',color: Colors.white,width: 35, height: 35),
