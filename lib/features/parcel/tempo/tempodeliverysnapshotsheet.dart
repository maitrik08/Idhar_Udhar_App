...
class TempoDeliverySnapshotContent extends StatelessWidget {
  const TempoDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/4.png',color: Colors.white,width: 35, height: 35),
