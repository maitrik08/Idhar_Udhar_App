...
import 'containertruckparceldriverdetail.dart';

class ContainerTruckParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const ContainerTruckParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const ContainerTruckParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
