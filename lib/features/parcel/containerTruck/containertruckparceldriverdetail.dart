...
class ContainerTruckParcelDriverDetailsPopup extends StatelessWidget {
  const ContainerTruckParcelDriverDetailsPopup({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Image.asset(
                  'assets/images/ride/truckvector.png',
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, '/chatparcelbikedriver');
                        },
                      ),
