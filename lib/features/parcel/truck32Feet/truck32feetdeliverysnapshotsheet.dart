...
class Truck32feetDeliverySnapshotContent extends StatelessWidget {
  const Truck32feetDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/9.png',color: Colors.white,width: 35, height: 35),
              const SizedBox(width: 10),
              Expanded(
                child: Text("32 Feet Multi Axle Truck",
