...
import 'truck32feetparceldriverdetail.dart';

class Truck32feetParcelDetailsPopup extends StatelessWidget {
  final String pin;

  const Truck32feetParcelDetailsPopup({super.key, this.pin = "1234"});
                          ...
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                ...
                                builder: (context) => const Truck32feetParcelDriverDetailsPopup(),
                              );
                            },
                            child: Container(
                              decoration: BoxDecoration(
