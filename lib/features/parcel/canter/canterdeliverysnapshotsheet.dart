...
class CanterDeliverySnapshotContent extends StatelessWidget {
  const CanterDeliverySnapshotContent({super.key});
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset('assets/images/delivery/vehicle/5.png',color: Colors.white,width: 35, height: 35),
